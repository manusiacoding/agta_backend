	...
	<body class="horizontalmenu dark-theme">
						...
						<div class="col-lg-12 col-md-12">
							...
							<form id="formadd" method="post">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h5 class="main-content-label mb-2">Add Product</h5>
										</div>
										<div class="">
											<div class="row row-xs align-items-center mg-b-20">
												...
												<div class="col-md-8 mg-t-5 mg-md-t-0">
													<input class="form-control" placeholder="Enter product name" type="text" id="nama" required>
												</div>
											</div>
											<div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
												...
												<div class="col-md-8 mg-t-5 mg-md-t-0">
													<input class="form-control" placeholder="Enter product price" type="text"  id="harga" required>
												</div>
											</div>
											<div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Product Description</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
													<textarea name="deskripsi" class="form-control" cols="20" rows="5" placeholder="Enter product description"  id="deskripsi" required></textarea>
												</div>
											</div>
											<div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Product Type</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
						...
						<div class="col-lg-12 col-md-12">
							<form id="formdetail" method="post">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h5 class="main-content-label mb-2">Add Detail Product</h5>
										</div>
										<div class="">
											<div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Model Name / Product Color</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
													<input class="form-control" placeholder="Enter model name / color" type="text" id="model" required>
												</div>
											</div>
											<div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Product Stock</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
													<input class="form-control" placeholder="Enter product stock" type="text"  id="stock" required>
												</div>
											</div>
											<div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Product Weight</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
													<input class="form-control" placeholder="Enter product weight" type="text"  id="berat" required>
												</div>
											</div>
											<div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Product Size</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
													<input class="form-control" placeholder="Enter product size" type="text"  id="size" required>
												</div>
											</div>
											<div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Product Image</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
											...
											<div class="form-group row justify-content-end mb-0">
												<div class="col-md-8 pl-md-2">
													<input type="button" class="btn ripple btn-primary pd-x-30 mg-r-5" id="savedetail" value="Save"/>
													<input type="button" class="btn ripple btn-secondary pd-x-30" id="canceldetail" value="Cancel" />
													<input type="button" class="btn ripple btn-info pd-x-30 mg-r-5" id="new" value="Add New Product"/>
												</div>
											</div>
										</div>
									</div>
        ...
        <script>
            $(document).ready(function(){
				...
				$('#canceldetail').attr("disabled", true);
				
				$('#save').off().on('click', function(e){
					e.preventDefault();
					var valnama = $('#nama').val();
					var valharga = $('#harga').val();
					var valdeskripsi = $('#deskripsi').val();
					var valjenis = $('#jenis').val();

					if(valnama=="" || valharga=="" || valdeskripsi=="" || valjenis==""){
						swal(
							"Oopss..",
						...
						$.ajax({
							...
							success: function(dataResult){
								...
								if(dataResult.statusCode==200){
									swal(
										"Success!",
										"You've been saved this product!",
										"success"
									);
									$('#formadd input').attr('readonly', true);
									$('#deskripsi').attr('readonly', true);
									$('#jenis').attr("disabled", true); 
									$('#save').attr("disabled", true); 
									$('#cancel').attr("disabled", true); 

									$('#formdetail input').attr('readonly', false);
									$('#file').attr("disabled", false); 
									$('#savedetail').attr("disabled", false); 
									$('#canceldetail').attr("disabled", false); 

									$.ajax({
										type: "GET",
										url: "function/retrieve-product_id.php",             
										dataType: "html",
				...
				$('#file').change(function(e){
					...
					// alert(fileName);
					$("#savedetail").off().on('click', function(e){
						e.preventDefault();
						...
						if(file_data != undefined) {
							...
							$.ajax({
								...
								success:function(response) {
									// alert('ok');
									var xhr = $.ajax({
										url: "function/add-detail-product.php",
										type: "POST",
										cache: false,
										data:{
											id_produk: $("#product_id").val(),
											model: $('#model').val(),
											stock: $('#stock').val(),
											berat: $('#berat').val(),
											size: $('#size').val(),
				...
				$('#new').off().on('click', function(){
					// 
					$('#formadd').trigger('reset');
					$('#formadd input').attr('readonly', false);
