						...
						<div class="col-lg-12 col-md-12">
							...
							<form id="formadd" method="post">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h5 class="main-content-label mb-2">Setting</h5>
										</div>
										<div class="">
                                            <?php 
                                                $query = mysqli_query($koneksi, "SELECT * FROM settings");
                                                $data = mysqli_fetch_assoc($query);
                                            ?>
											<div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Sameday Agta Courier Service</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
                                                    <input type="hidden" id="idsetting" value="<?php echo $data['id_setting']; ?>">
													<input class="form-control" type="text" id="agtasamedayservice" value="<?php echo $data['service_kurir_agta_sameday'] ?>">
												</div>
											</div>
											<div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Sameday Agta Courier Price</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" type="text" id="agtasamedayprice" value="<?php echo $data['harga_kurir_agta_sameday']; ?>">
												</div>
											</div>
                                            <div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Courier Estimate Agta Sameday</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" type="text" id="agtasamedayestimate" value="<?php echo $data['estimasi_kurir_agta_sameday']; ?>">
												</div>
											</div>
                                            <hr>
                                            <div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Cargo Agta Courier Service</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" type="text" id="agtacargoservice" value="<?php echo $data['service_kurir_agta_cargo']; ?>">
												</div>
											</div>
                                            <div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Cargo Agta Courier Price</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" type="text" id="agtacargoprice" value="<?php echo $data['harga_kurir_agta_cargo']; ?>">
												</div>
											</div>
                                            <div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Courier Estimate Agta Cargo</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" type="text" id="agtacargoestimate" value="<?php echo $data['estimasi_kurir_agta_cargo']; ?>">
												</div>
											</div>
                                            <hr>
                                            <div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Shopee Link</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" type="text" id="linkshopee" value="<?php echo $data['link_shopee']; ?>">
												</div>
											</div>
                                            <div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">About Us Link</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" type="text" id="linkaboutus" value="<?php echo $data['link_tentang_kami']; ?>">
												</div>
											</div>
                                            <div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Whatsapp Link</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" type="text" id="linkwhatsapp" value="<?php echo $data['link_whatsapp']; ?>">
												</div>
											</div>
        ...
        <script>
            $(document).ready(function(){
                $('#save').off().on('click', function(e){
                    e.preventDefault();
                    $.ajax({
                        url: 'function/update-setting.php',
                        type: 'POST',
                        cache: false,
                        data:{
                            id: $('#idsetting').val(),
                            servicesameday : $('#agtasamedayservice').val(),
                            pricesameday : $('#agtasamedayprice').val(),
                            estimatesameday : $('#agtasamedayestimate').val(),
                            servicecargo : $('#agtacargoservice').val(),
                            pricecargo : $('#agtacargoprice').val(),
                            estimatecargo : $('#agtacargoestimate').val(),
                            linkshopee : $('#linkshopee').val(),
                            linkaboutus : $('#linkaboutus').val(),
                            linkwhatsapp : $('#linkwhatsapp').val(),
                        },
                        success:function(dataResult){
                            ...
                            if(dataResult.statusCode==200){
                                swal(
                                    "Well Done!",
                                    "You've been update this settings",
                                    "success"
                                );
