						...
						<div class="col-lg-12 col-md-12">
							<form id="formadd" method="post">
								<div class="card custom-card mt-5">
									<div class="card-body">
										<div>
											<h5 class="main-content-label mb-2">Edit Profile</h5>
										</div>
										<div class="">
											<div class="row row-xs align-items-center mg-b-20">
												...
												<div class="col-md-8 mg-t-5 mg-md-t-0">
													...
													<input class="form-control" placeholder="Enter Username" type="text" id="username" required>
												</div>
											</div>
                                            <div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
												...
												<div class="col-md-8 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" placeholder="Enter Password" type="password" id="password" required>  
												</div>
											</div>
                                            <div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
												...
												<div class="col-md-8 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" placeholder="Enter Confirm Password" type="password" id="confirmpass" required>  
												</div>
											</div>
                            ...
                            <form id="formadd" method="post">
								<div class="card custom-card mb-5">
									<div class="card-body">
										<div>
											<h5 class="main-content-label mb-2">Delete Account</h5>
                                            <p class="tx-12 tx-gray-500 mt-0 mb-2">This action deletes and everything this data contains. There is no going back</p>
                                            
										</div>
										<div class="">
											<div class="form-group row justify-content-end mb-0">
												<div class="col-md-12 pt-2">
													<input type="button" class="btn ripple btn-danger pd-x-30" id="delete" value="Delete" />
												</div>
											</div>
										</div>
									</div>
