						...
						<div class="col-lg-12 col-md-12">
							...
							<form id="formadd" method="post">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h5 class="main-content-label mb-2">Add Blog</h5>
										</div>
										<div class="">
											<div class="row row-xs align-items-center mg-b-20">
												...
												<div class="col-md-8 mg-t-5 mg-md-t-0">
													<input class="form-control" placeholder="Enter Title" type="text" id="title" required>
												</div>
											</div>
											<div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
                                            ...
                                            <div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
													<label class="mg-b-0">Author</label>
												</div>
												<div class="col-md-8 mg-t-5 mg-md-t-0">
													<input class="form-control"type="text" id="author" value="Administrator" readonly />
												</div>
											</div>
                                            <div class="row row-xs align-items-center mg-b-20">
												<div class="col-md-4">
												...
												<div class="col-md-8 mg-t-5 mg-md-t-0">
													<!-- <input class="form-control"type="text" id="nama" value="Administrator" readonly /> -->
            ...
            $(document).ready(function(){
                $('#file').change(function(e){
					...
					$('#save').off().on('click', function(e){
						e.preventDefault();
						var valjudul = $('#title').val();
						var valisi = $('#isi').val();
						var valauthor = $('#author').val();
						var valstatus = $('#status').val();
						var valfile = $('#file').prop('files')[0];

						if(valjudul=="" || valisi=="" || valauthor=="" || valstatus=="" || !valfile){
							swal(
								"Oopss..",
