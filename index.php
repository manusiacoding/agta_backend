<?php
    if(isset($_GET['pesan'])){
        if($_GET['pesan'] == "gagal"){
            ...
            echo "<script>alert('Anda harus login untuk mengakses halaman dashboard');</script>";
        }
    }
?>
<!DOCTYPE html>
						...
						<div class="row row-sm">
							<div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
								<div class="mt-5 pt-4 p-2 pos-absolute">
									...
									<h5 class="mt-4 text-white">Welcome To AGTA Dashboard</h5>
								</div>
							</div>
								...
								<div class="container-fluid">
									<div class="row row-sm">
										<div class="card-body mt-2 mb-2">
											...
											<div class="clearfix"></div>
											<form method="POST" action="function/login-action.php">
