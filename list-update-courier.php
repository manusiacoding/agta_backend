	...
	<body class="horizontalmenu dark-theme">
									...
									<div class="modal-body">
										<form  method="POST" class="formproduk">
												...
												<div class="form-group">
													...
													<input type="text" name="author" class="form-control" id="status" readonly>
												</div>
												</div>
		...
		<script>
			$(document).ready(function(){
                ...
                $('#example1').dataTable({
                    proccesiong: true,
                    ajax: 'function/view-update-courier.php',
                    order: [[0, 'desc']],
                    columns:[
                        {data: 'id_transaksi'},
                        {data: 'no_resi'},
                ...
                $('#idtransaction').bind('change', function(e){
                    ...
                    idtransaction = $(this).val();
                        ...
                        $.ajax({
                        url: 'function/ajaxrespon-update-courier.php',
                        type: 'GET',
                        dataType: 'json',
                        data: {
                        ...
                        success: function(data){
                            $('#noresil').val(data['noresi']);
                            if(data['status'] == "2"){
                                $('#status').val("Pesanan Dikirim");
                            }
                        }
                    });
                    ...
                    $("#idtransaction").bind('change', function(e){
                        ...
                        $('#update').off().on('click', function(e){
                            ...
                            if(status == "3"){
                                ...
                                $.ajax({
                                    url: 'function/update-courier.php',
                                    type: 'POST',
                                    cache: false,
                                    data:{
                                    ...
                                    success: function(dataResult){
                                        ...
                                        if(dataResult.statusCode==200){
                                            swal(
                                                "Well Done!",
                                                "You've been updated this transaction",
                                                "success"
                                            );
                                            $('#myModal').modal('hide');
